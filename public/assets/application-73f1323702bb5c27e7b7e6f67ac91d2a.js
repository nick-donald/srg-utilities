...
SrgUtilities.Collections.Queries = Backbone.Collection.extend({
	url: '/addresser'
});
...
SrgUtilities.Models.QueryResults = Backbone.Model.extend({
	url: '/addresser'
});
...
SrgUtilities.Routers.QueryRouter = Backbone.Router.extend({
	routes: {
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/app/sidebar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push(''); if (SrgUtilities.session.authenticated()) { __p.push('\n<div id="sidebar">\n\t<div id="sidebar-container">\n\t\t<ul id="sidebar-buttons">\n\t\t\t<li class="sidebar-button"><a href="/query/new">New Query</a></li>\n\t\t\t<li class="sidebar-button"><a href="/query/all">Previous Queries</a></li>\n\t\t\t<li class="sidebar-button"><a href="#">Item 3</a></li>\n\t\t</ul>\n\t</div>\n</div>\n'); } __p.push('\n\n', console.log("header auth: " + SrgUtilities.session.authenticated()) ,'\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/base_views/home"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('', JST['backbone/templates/app/sidebar']() ,'\n<div id="load-target" class="active">\n'); if (!SrgUtilities.session.authenticated()) { __p.push('\n\t<h2 class="title">Please Log In</h2>\n\t<span><a href="/login" class="btn">login</a></span>\n'); } __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/base_views/login"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Please log in to continue</h1>\n<form id="login-form">\n<label>Email</label>\n<input type="text" name="email" id="email"></input>\n<label>Password</label>\n<input type="password" name="password" id="password"></input>\n<button type="submit" name="login" id="login">Login</button>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/download"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<iframe src=\'', "/query/downloadexcel?query_id=" + query_id ,'\' style="display:none;"></iframe>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Edit query_result</h1>\n\n<form id="edit-query_result" name="query_result">\n  <div class="actions">\n    <input type="submit" value="Update Query results" />\n  </div>\n\n</form>\n\n<a href="#/index">Back</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Listing query_results</h1>\n\n<table id="results-table" border="1" style="border-collapse:collapse; float:left;">\n\t<thead style="border-bottom:solid 3px;">\n\t\t<tr>\n\t\t\t<th>Query ID</th>\n\t\t\t<th>Query</th>\n\t\t\t<th>City</th>\n\t\t\t<th>Radius</th>\n\t\t\t<th>Created At</th>\n\t\t\t<th></th>\n\t\t</tr>\n\t</thead>\n\t<tbody>\n\t\t'); for (i = 0; i < results.models.length; i++) { __p.push('\n\t\t<tr><td>', results.models[i].get('id') ,'</td><td>', results.models[i].get('query') ,'</td><td>', results.models[i].get('center') ,'</td><td>', results.models[i].get('radius') ,'</td><td>', results.models[i].get('created_at').split('T').shift() ,'</td><td><a class="query-detail" data-id="', results.models[i].get('id') ,'" href="/query/all/detail">Details</a></td></tr>\n\t\t'); } __p.push('\n\t</tbody>\n</table>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/index_detail"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push(''); if (results.length) { __p.push('\n\n<table id="results-table" border="1" style="border-collapse:collapse; float:left;">\n\t<thead style="border-bottom:solid 3px;">\n\t\t<tr>\n\t\t\t<th>ID</th>\n\t\t\t<th>Name</th>\n\t\t\t<th>Address</th>\n\t\t</tr>\n\t</thead>\n\t<tbody>\n\t\t'); for (i = 0; i < results.models.length; i ++) { __p.push('\n\t\t\t<tr><td>', results.models[i].get('query_id') ,'</td><td>', results.models[i].get('name') ,'</td><td>', results.models[i].get('address') ,'</td><td><a href="#" class="remove" data-entry="', i ,'">Remove</a></td></tr>\n\t\t'); } __p.push('\n\t</tbody>\n</table>\n\n'); } __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>New Query</h1>\n\n<div id="target">\n\t<form id="form-new-query" name="query">\n\t  <div class="actions">\n\t  \t<label name="stores" for="stores">Stores</label>\n\t  \t<input id="stores" type="text" name="stores"/>\n\t  \t<label name="city" for="city">City</label>\n\t  \t<input id="city" type="text" name="city" />\n\t  \t<label name="radius" for="radius">Radius</label>\n\t  \t<input id="radius" type="text" name="radius"/>\n\t    <input type="submit" value="Search"/>\n\t  </div>\n\n\t</form>\n</div>\n\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/query_map"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="map-canvas"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/query_results"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<td><a href="#/', id ,'">Show</td>\n<td><a href="#/', id ,'/edit">Edit</td>\n<td><a href="#/', id ,'/destroy" class="destroy">Destroy</a></td>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/results_table"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<table id="results-table" border="1" style="border-collapse:collapse; float:left;">\n\t<thead style="border-bottom:solid 3px;">\n\t\t<tr>\n\t\t\t<th>Name</th>\n\t\t\t<th>Chain</th>\n\t\t\t<th>Address</th>\n\t\t</tr>\n\t</thead>\n\t<tbody>\n\t\t'); for (i = 0; i < results.models.length; i ++) { __p.push('\n\t\t\t<tr><td>', results.models[i].get('name') ,'</td><td>', results.models[i].get('store_name') ,'</td><td>', results.models[i].get('vicinity') ,'</td><td><a href="#" class="remove" data-entry="', i ,'">Remove</a></td></tr>\n\t\t'); } __p.push('\n\t</tbody>\n</table>\n\n'); if (results.models.length) { __p.push('\n\t<button name="get-map" value="get-map" id="get-map">Get Map</button>\n\t<button id="get-static-map" disabled="disabled">Get Map Image</button>\n\t<button name="get-excel" value="get-excel" id="get-excel">Get Excel Spreadsheet</button>\n'); } __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/query_results/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Show</h1>\n');}return __p.join('');};
}).call(this);
...
(function() {
  ...
  (_base = SrgUtilities.Views).QueryResults || (_base.QueryResults = {});

  SrgUtilities.Views.QueryResults.EditView = (function(_super) {
    ...
    EditView.prototype.template = JST["backbone/templates/query_results/edit"];
    ...
    EditView.prototype.update = function(e) {
      ...
      return this.model.save(null, {
        success: function(query_results) {
          _this.model = query_results;
